...
const APIKEY = '10833dc37b6904a9ee719c8f4ba40c01724965ea993e56605603ff4cb54591a7';
...
async function choose(userId, sessionId, dyContext, selectors = []) {
    ...
    try {
      ...
      console.log({responseSlotsLength: response.choices[0].variations[0].payload.data.slots.length});
    } catch (e) {
